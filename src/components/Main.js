    ...
    <div className="App">
        <Center h='100vh'>
            <VStack divider={<StackDivider borderColor='gray.200' />} spacing={4} align='stretch'>
                ...
                <section>
                    <Box p={3} m={3} border="2px" borderColor="teal.500" borderRadius="5" w='xl'>
                        <VStack spacing={4} align='center'>
                            <Text fontSize='md' pb="1%" >Choose game mode (Player vs Player or Computer)</Text>

                            <Stack spacing={4} pb="2%" direction='row' align='center'>
                            ...
                            {type === 1 ? (
                            <>
                                <Text fontSize='md' pb="1%" >Choose Game Mode:</Text>
                ...
                <section>
                    <Box p={3} m={3} border="2px" borderColor="teal.500" borderRadius="5" w='xl'>
                        <Text fontSize='md' >Game Information:</Text>
                        <Text fontSize='sm' >Rock paper scissors is a hand game, usually played between two people, which each player simultaneously forms one of three shapes with an outstretched hand. These shapes are "rock" (a closed fist), "paper" (a flat hand), and "scissors" (hand forming a V).</Text>
                    </Box>
                </section>
                <section>
                    <Box p={3} m={3} border="2px" borderColor="teal.500" borderRadius="5" w='xl'>
